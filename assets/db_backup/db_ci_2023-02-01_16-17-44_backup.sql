...
INSERT INTO `barang` (`id_barang`, `kode_barang`, `nama_barang`, `harga`, `stok`, `foto_barang`, `id_jenis`, `id_merk`, `kode_supplier`) VALUES (7, 'BRG0001', 'AAA', 25000, 12, 'barang_1675263732', 4, 3, '1223');
...
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES (22, 7, 'Daftar Hutang', 'data/hutang', 'fas fa-fw fa-credit-card', 1);
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES (23, 7, 'Daftar Piutang', 'data/piutang', 'fas fa-fw fa-credit-card', 1);
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES (24, 7, 'Daftar Aset', 'data', 'fas fa-fw fa-car', 1);
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES (25, 13, 'Pajak Penghasilan', 'perhitungan', 'fas fa-fw fa-superscript', 1);
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES (28, 14, 'Backup Database', 'database/take_backup', 'fas fa-fw fa-database', 1);
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES (30, 12, 'Data Barang', 'barang', 'fas fa-fw fa-suitcase', 1);
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES (31, 12, 'Jenis Barang', 'jenis_barang', 'fas fa-fw fa-server', 1);
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES (32, 12, 'Merk Barang', 'merk_barang', 'fas fa-fw fa-tasks', 1);
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES (33, 12, 'Supplier Barang', 'supplier', 'fas fa-fw fa-sitemap', 1);
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES (34, 12, 'Transaksi Barang Masuk', 'barang_masuk', 'fas fa-fw fa-file', 1);
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES (35, 12, 'Transaksi Barang Keluar', 'barang_keluar', 'fas fa-fw fa-file', 1);
