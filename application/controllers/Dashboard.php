...
class Dashboard extends CI_Controller
{
	...
	public function index()
	{
		...
		//CASH IN HAND
		$data['cash_in_hand'] = $this->Statement_model->count_head_amount_by_id(47);		

		//ACCOUNT RECEIVABLE
		$data['account_recieveble'] = $this->Statement_model->count_head_amount_by_id(48);		

		//CASH IN BANK
		$data['cash_in_bank'] = $this->Statement_model->count_head_amount_by_id(16);		

		//PAYABLES
		$data['payables'] = $this->Statement_model->count_head_amount_by_id(60);		
