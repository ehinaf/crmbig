    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_piutang" name="nama_piutang" required>
          </div>
          
          <div class="form-group">
            <label>Tanggal Piutang :</label>
            <input type="date" class="form-control" id="tanggal_piutang" name="tanggal_piutang" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" required>
          </div>
          <div class="form-group">
            <label>Debit :</label>
