    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="jumlah_unit" name="jumlah_unit" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" required>
          </div>
          <div class="form-group">
            <label>Umur Manfaat (Bulan) :</label>
            <input type="text" class="form-control" id="umur_manfaat" name="umur_manfaat" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" required>
          </div>
          <div class="form-group">
            <label>Harga Perolehan :</label>
            <input type="text" class="form-control" id="harga_perolehan" name="harga_perolehan" onkeyup="OnChange(this.value)" onKeyPress="return isNumberKey(event)" required>
          </div>
          <div class="form-group">
            <label>Akumulasi Penyusutan (Perbulan) :</label>
            <input type="text" class="form-control" id="akumulasi_penyusutan" name="akumulasi_penyusutan" readonly="readonly" required>
          </div>
