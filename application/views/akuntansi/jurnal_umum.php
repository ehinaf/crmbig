...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <a href="<?= base_url('statements/journal_voucher_adj') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mr-2"><i class="fas fa-plus fa-sm"></i> Tambah Penyesuaian</a><br><br>
